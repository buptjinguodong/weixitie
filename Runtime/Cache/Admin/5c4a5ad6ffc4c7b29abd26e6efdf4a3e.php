			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						...
						<div class="controls">
							<?php $_result=get_modelListdoc();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><label class="checkbox">
...
<div class="form-item">
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('Catearticle/index');?>');
	</script>

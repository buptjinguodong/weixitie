...
<body>
 ...
 <?php if(isset($cate_rows)): ?></div><?php endif; ?> 
	...
	<script type="text/javascript" src="/cms/yershop/Public/static/uploadify/jquery.uploadify.min.js"></script>
		<script type="text/javascript" src="/cms/yershop/Public/static/UploadImages.js"></script><div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>粉丝信息</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div class="form-item">
			<label class="item-label">换货商品<span class="check-tips">（用于显示的文字）</span></label>
			<div class="controls">
				<input type="hidden" class="text input-large"  name="goodid"  value="<?php echo ($info["goodid"]); ?>">
				<?php echo (get_good_name($info["shopid"])); ?>
			</div>
		</div>

<div class="form-item">
			<label class="item-label">规格<span class="check-tips"></label>
			<div class="controls">
				<input type="text" class="text input-large" name="parameters" value="<?php echo ($info["parameters"]); ?>" >
			</div>
		</div>
		<div class="form-item">
...
<div class="form-item">
	...
	<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="tool" value="<?php echo ($info["toolid"]); ?>" >
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('UserCenter/index');?>');
	</script>

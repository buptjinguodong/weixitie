		...
		<div class="tab-content">
			...
			<div class="form-item">
						<label class="item-label">
							留言id<span class="check-tips"></span>
						</label>
						<div class="controls">
							<input type="text" name="messageid" class="text input-large" value="<?php echo ((isset($info["messageid"]) && ($info["messageid"] !== ""))?($info["messageid"]):''); ?>">
						</div>
					</div>
						<div class="form-item">
						<label class="item-label">
							回复uid<span class="check-tips"></span>
						</label>
						<div class="controls">
							<input type="text" name="uid" class="text input-large" value="<?php echo ((isset($info["uid"]) && ($info["uid"] !== ""))?($info["uid"]):''); ?>">
						</div>
					</div>
						<div class="form-item">
...
<div class="form-item">
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('Reply/index');?>');
	</script>

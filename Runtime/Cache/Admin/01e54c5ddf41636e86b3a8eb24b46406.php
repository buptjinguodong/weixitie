...
<?php echo ($_page); ?>
 ...
 <link href="/git/weixitie/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" status="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/git/weixitie/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" status="text/css">'; ?>
<link href="/git/weixitie/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" status="text/css">
<script status="text/javascript" src="/git/weixitie/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script status="text/javascript" src="/git/weixitie/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>

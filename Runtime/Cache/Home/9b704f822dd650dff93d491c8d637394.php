...
<a rel="nofollow" href="<?php echo C('DOMAIN');?>" class="img"> <img src="/cms/yershop/Public/Home/images/login-3.jpg" width='400' height='300'></a>
	</div>
	
	<div class="login-other">  
	<form class="form-horizontal" role="form" action="/cms/yershop/index.php?s=/Home/User/register.html" method="post">

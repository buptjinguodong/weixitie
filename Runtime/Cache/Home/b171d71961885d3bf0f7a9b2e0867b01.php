...
<link href="/cms/yershop/Public/Home/css/font-face.css" rel="stylesheet">
...
<div class="header-wrap"><a href="<?php echo C('DOMAIN');?>" class="logo" title="<?php echo C('WEB_SITE_TITLE');?>"><img src="/cms/yershop/Public/Home/images/logo.png" alt="<?php echo C('WEB_SITE_TITLE');?>"></a>
...
<div class="hd">
	...
	<a rel="nofollow" href="<?php echo C('DOMAIN');?>" class="img"><img src="/cms/yershop/Public/Home/images/login-3.jpg" width='400' height='300'></a></div><div class="login-other">  <form class="form-horizontal login-user"  action="<?php echo U("User/login");?>" id="loginform" name="user" method="post">

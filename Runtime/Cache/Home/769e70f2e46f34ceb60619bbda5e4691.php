...
<head>
<link href="/git/weixitie/Public/Home/css/top.css" rel="stylesheet">
<link href="/git/weixitie/Public/Home/css/common.css" rel="stylesheet">
<link href="/git/weixitie/Public/Home/css/footer.css" rel="stylesheet">
<link href="/git/weixitie/Public/Home/css/modify.css" rel="stylesheet">
<script type="text/javascript" src="/git/weixitie/Public/Home/js/public.js"></script>
...
<div class="header">
<a href="" class="logo" title="<?php echo C('WEB_SITE_TITLE');?>"><img src="/git/weixitie/Public/Home/images/logo.png" alt="<?php echo C('WEB_SITE_TITLE');?>"></a>
...
<div class="nav-wrap">
 <!--fenlei begin--> <div class="nava">
    <div class="goods">
      <div>
        <h2 class="text-center">您好，欢迎登录总行门户</h2>
      </div>
    </div>
...
//购物车删除结束
   ...
   <!-- 购物车js -->
    ...
    <!-- 底部-->
   <script type="text/javascript"  charset="utf-8" src="/git/weixitie/Public/static/js/menudown.js"></script> 

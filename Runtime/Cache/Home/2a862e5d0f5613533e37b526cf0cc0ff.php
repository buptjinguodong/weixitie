...
<link href="/cms/yershop/Public/Home/css/detail.css" rel="stylesheet">

<link href="/cms/yershop/Public/Home/css/footer.css" rel="stylesheet">
<!-- 评论统计工具 -->
<link href="/cms/yershop/Public/Home/css/jquery.circliful.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/cms/yershop/Public/Home/js/public.js"></script>
<script type="text/javascript" src="/cms/yershop/Public/static/js/jquery.min.js"></script>
</head>
<body>
<!-- 工具条 -->
...
<div id="zoom">
	...
	<div id="spec-n5">
		<div class="control" id="spec-left">
			<img src="/cms/yershop/Public/Home/images/btn_mobile_prev_cur.jpg" />
		</div>
		<div id="spec-list">
  ...
  <li class="img"><img src="<?php echo (get_cover($info["cover_id"],'path')); ?>" height="50" width="50"/></li>
   <?php if(!empty($pics)): if(is_array($pics)): $i = 0; $__LIST__ = $pics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><img src="/cms/yershop<?php echo (get_cover($v,'path')); ?>" data-id="<?php echo ($v); ?>"/> </li><?php endforeach; endif; else: echo "" ;endif; endif; ?> 
		<?php if(empty($pics)): ?><li><img src="/cms/yershop/Public/Home/images/2-1.jpg"> </li>
				<li><img src="/cms/yershop/Public/Home/images/2-2.jpg"> </li>	
			<li><img src="/cms/yershop/Public/Home/images/2-3.jpg"> </li>
		<li><img src="/cms/yershop/Public/Home/images/2-4.jpg"> </li><?php endif; ?>
			</ul>
		</div>
		<div class="control" id="spec-right">
			<img src="/cms/yershop/Public/Home/images/btn_mobile_next_cur.jpg" />
		</div>
    </div>
</div><!-- wwww over--> <!-- 商品参数-->
...
<!-- buy-->
<p>
<span>收藏产品：<a href="javascript:vod(0);" onclick="favor();return false;"><img title="收藏按钮" src="/cms/yershop/Public/Home/images/icon_favorite_pro.jpg" ></a>
</span>
&nbsp;&nbsp;&nbsp;&nbsp;<span>&nbsp;&nbsp;&nbsp;分享到：<a title="分享到新浪微博" target="_blank" href="http://service.t.sina.com.cn/share/share.php?title=<?php echo ($info["title"]); ?>。（来自<?php echo C('SITENAME');?>）&amp;url=<?php echo C('DOMAIN'); echo U('Article/detail?id='.$info['id']);?>&amp;pic=<?php echo C('DOMAIN'); echo (get_cover($info["cover_id"],'path')); ?>" data-item="sina" class="J_vivo_share">
            <img alt="新浪微博" src="/cms/yershop/Public/Home/images/icon_sina_weibo.jpg" app="b2c">        </a>                                                                
        <a title="分享到腾讯微博" target="_blank" href="http://v.t.qq.com/share/share.php?title=<?php echo ($info["title"]); ?>（来自<?php echo C('SITENAME');?>）。&amp;url=<?php echo C('DOMAIN'); echo U('Article/detail?id='.$info['id']);?>&amp;pic=<?php echo C('DOMAIN'); echo (get_cover($info["cover_id"],'path')); ?>" data-item="tencent" class="J_vivo_share">
            <img alt="腾讯微博" src="/cms/yershop/Public/Home/images/icon_tencent_weibo.jpg" app="b2c">        </a>                                                                
        <a target="_blank" title="分享到人人网" href="http://widget.renren.com/dialog/share?resourceUrl=<?php echo C('DOMAIN'); echo U('Article/detail?id='.$info['id']);?>;srcUrl=<?php echo C('DOMAIN');?>&amp;title=<?php echo ($info["title"]); ?>。（来自<?php echo C('SITENAME');?>）&amp;pic=<?php echo C('DOMAIN'); echo (get_cover($info["cover_id"],'path')); ?>" data-item="renren" class="J_vivo_share">
            <img alt="人人网" src="/cms/yershop/Public/Home/images/icon_renrenwang.jpg" app="b2c">        </a>           
</span></p>
...
<SCRIPT src="/cms/yershop/Public/static/js/base.js" type=text/javascript></SCRIPT>
...
<SCRIPT src="/cms/yershop/Public/static/js/jqueryzoom-jcarousel.js" type="text/javascript"></SCRIPT>
<!-- js over-->
<!-- jqzoom over-->
<!-- 商品参数-->
...
<?php echo (date('Y-m-d H:i',$list["create_time"])); ?></span>                     <span class="items_tips fr">                                                                  </span>                      </div>                                               </div>         </div>     </li><?php endforeach; endif; else: echo "无" ;endif; ?>
  ...
  <!--精彩评论tabs-->  
<script src="/cms/yershop/Public/Home/js/jquery.idTabs.min.js"></script>
	<script type="text/javascript"> 
  $(".comment_tabs").idTabs();
</script>
  <!--精彩评论tabs-->  
 ...
 <div id="header4" class="choose" style="display:none">
   ...
   <div class="item_wrap" id="boxquest">
	   <?php if(is_array($listquestion)): $i = 0; $__LIST__ = $listquestion;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?><div class="qa_cont clearfix">
					...
					<span><img src="/cms/yershop/Public/Home/images/question.png">问：<?php echo ($m["content"]); ?>？</span></div>   
		
		  	 
		 <?php if(is_array($m['id'])): $i = 0; $__LIST__ = $m['id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?><div class="answer"><span class="time"><?php echo (date('Y-m-d H:i',$re["create_time"])); ?></span><span><b><img src="/cms/yershop/Public/Home/images/anwser.png">商家：<?php echo ($re["content"]); ?></b></span></div><?php endforeach; endif; else: echo "" ;endif; ?>  
		   </div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<?php echo ($pagequestion); ?>
  ...
  $.post("<?php echo U('service/addmessage');?>", {
    ...
    var html='<div class="qa_cont clearfix"><div class="question"><span class="time">'+data.time+'</span><span><img src="/cms/yershop/Public/Home/images/question.png">问：'+str+'？</span></div>            </div>';
...
<A class="close" onclick="closeBg();"><img src="/cms/yershop/Public/Home/images/close.png"></A>
<h3 id="myModalLabel">用户登录</h3>
</div><div class="m_img">
        <a class="" href="/index.php?s=/Home/Addons/execute/_addons/SyncLogin/_controller/Base/_action/login/type/qq.html"><img src="/cms/yershop/Public/Home/images/qq.png">&nbsp;用QQ账号登录</a></br></br>
        <a class="" href="/index.php?s=/Home/Addons/execute/_addons/SyncLogin/_controller/Base/_action/login/type/sina.html"><img src="/cms/yershop/Public/Home/images/weibo.png">&nbsp;用微博账号登录</a>

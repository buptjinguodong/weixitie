...
<div class="header-wrap"><a href="<?php echo C('DOMAIN');?>" class="logo" title="<?php echo C('WEB_SITE_TITLE');?>"><img src="/cms/yershop/Public/Home/images/logo.png" alt=""></a>
...
{if(data.msg=="yes"){
 ...
 <link type="text/css" href="/cms/yershop/Public/Home/css/selectpick.css"
	rel="stylesheet" />    
...
<script type="text/javascript" src="/cms/yershop/Public/Home/js/city.js"></script>
				<script type="text/javascript">

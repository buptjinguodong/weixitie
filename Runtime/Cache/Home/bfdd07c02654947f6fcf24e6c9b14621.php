...
/cms/yershop/Public/Home/js/jquery.tips.js"></script>
...
$(document).ready(function(){ 
   ...
   <div class="count">
    <dl><dt><?php if(($faceid) > "0"): ?><a href='<?php echo U("member/index");?>'><img src="/cms/yershop/Public/Home/images/info.jpg" width="100" height="100"/></a><?php else: ?>
...
<form action='<?php echo U("Shopcart/delorder");?>' method="post" name="delform" >
	  ...
	  <span class="good-status">交易状态</span> <span class="deal-action">交易操作</span></div>
		...
		<?php if(($po['status']) > "2"): ?><b><a href="<?php echo U('Shopcart/delorder?tag='.$po['tag']);?>" ><img src="/cms/yershop/Public/Home/images/iconfont-lajixiang.png" width="20" height="20"></a></b><?php endif; ?>
			   </div>
         <!-- 列表详情区域开始 -->  

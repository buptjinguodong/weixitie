...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/cms/yershop/Public/static/bootstrap/css/bootstrap.css" rel="stylesheet">
        <link href="/cms/yershop/Public/static/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">
        <link href="/cms/yershop/Public/Install/css/install.css" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/cms/yershop/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/cms/yershop/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
 ...
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/cms/yershop/install.php/Install/step2.html" method="post" target="_self">
